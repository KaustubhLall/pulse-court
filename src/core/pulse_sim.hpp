...
inline constexpr std::int32_t kJetstepCooldown = 240;           // mobility / cheapest
inline constexpr std::int32_t kAnchorCooldown = 390;            // large-area pull / high
inline constexpr std::int32_t kGateCooldown = 450;              // hard-block wall / highest
